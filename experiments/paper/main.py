...
def run_experiment_1():
    ...
    handler = FileSystemHandler(root_dir=f"results/paper/experiments/1/")
...
def run_experiment_2():
    ...
    handler = FileSystemHandler(root_dir=f"results/paper/experiments/2/")
    noise_tournament = NoiseTournament(
        players=[agent],
        noise_levels=noise_levels,
        repetitions=repetitions,
...
def run_experiment_3():
    ...
    handler = FileSystemHandler(root_dir=f"results/paper/experiments/3/")
    noise_tournament = NoiseTournament(
...
def run_experiment_4():
    ...
    handler = FileSystemHandler(root_dir=f"results/paper/experiments/4/")
    noise_tournament = NoiseTournament(
        players=[agent, axl.TitForTat(), axl.WinStayLoseShift()],
        noise_levels=noise_levels,
        repetitions=repetitions,
